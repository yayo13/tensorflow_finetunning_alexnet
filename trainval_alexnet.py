...
def main():
    base_path = '/home/cothink-tech/DATA/ARECA_NUT/model/alexnet/tensorflow/'
    data_path = '/home/cothink-tech/DATA/ARECA_NUT/'
    
    alex = alexnet_train_val()
    if which_func == funcs[0]:
        # fine tuning
        train_list = data_path + 'train.list'
        test_list = data_path + 'test.list'
        snapshot = base_path
        ...
        # validate
        val_list = data_path + 'val.list'
        mean_value = np.array([])
        result_file = base_path + 'precision.txt'
        checkpoint_file = base_path + 'model_epoch133.ckpt'
